...
public class SoftKeyboard extends InputMethodService implements
	...
	public void onInitializeInterface() {
		...
		mEnglishKeyboard = new LatinKeyboard(this, R.xml.english);
	...
	public View onCreateInputView() {
		...
		mInputView.setKeyboard(mEnglishKeyboard);
		return mInputView;
	}
...
/*	@Override
		...
		default:
			...
			if (PROCESS_HARD_KEYS) {
				if (keyCode == KeyEvent.KEYCODE_SPACE
					...
					InputConnection ic = getCurrentInputConnection();
					if (ic != null) {
						// First, tell the editor that it is no longer in
						// the
	...
	private void updateShiftKeyState(EditorInfo attr) {
		if (attr != null && mInputView != null
				&& mEnglishKeyboard == mInputView.getKeyboard()) {
			int caps = 0;
	...
	private void handleShift() {
		...
		if (mEnglishKeyboard == currentKeyboard) {
			// Alphabet keyboard
			checkToggleCapsLock();
